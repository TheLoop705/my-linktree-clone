  ...
  const testLinks = await Promise.all([
    prisma.link.upsert({
      ...
      create: {
        id: 'test-link-1',
        title: 'My Portfolio',
        url: 'https://example.com/portfolio',        description: 'Check out my latest work',
        isActive: true,
        position: 1,
        pageId: testPage.id,
      }
    ...
    prisma.link.upsert({
      ...
      create: {
        ...
        url: 'https://github.com/testuser',        description: 'My open source projects',
        isActive: true,
        position: 2,
        pageId: testPage.id,
      }
    ...
    prisma.link.upsert({
      ...
      create: {
        id: 'test-link-3',
        title: 'LinkedIn',
        url: 'https://linkedin.com/in/testuser',        description: 'Professional network',
        isActive: true,
        position: 3,
        pageId: testPage.id,
      }
