...
export default function ProfilePage() {
  ...
  const loadProfileData = async () => {
    try {
      ...
      setProfile({
        displayName: data.displayName || session?.user?.email?.split('@')[0] || "",
        bio: data.bio || "",
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update your personal information that will be displayed on your public page.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleProfileSubmit} className="space-y-4">
              <div>
                ...
                />
                {errors.displayName && (
                  <p className="text-sm text-red-600 mt-1">{errors.displayName[0]}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.profession && (
                  <p className="text-sm text-red-600 mt-1">{errors.profession[0]}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.location && (
                  <p className="text-sm text-red-600 mt-1">{errors.location[0]}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.websiteUrl && (
                  <p className="text-sm text-red-600 mt-1">{errors.websiteUrl[0]}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.profileImageUrl && (
                  <p className="text-sm text-red-600 mt-1">{errors.profileImageUrl[0]}</p>
                )}
              </div>
          ...
          <CardContent>
            ...
            {pageSettings.slug && (
              <div className="mt-4 p-4 bg-muted rounded-lg">
                ...
                >
                  {typeof window !== 'undefined' ? window.location.origin : 'http://localhost:3000'}/{pageSettings.slug}
                </a>
              </div>
            )}
          </CardContent>
